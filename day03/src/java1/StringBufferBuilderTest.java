...
public class StringBufferBuilderTest {
    ...
    public int indexOf(String str) 查询位置
    ...
    sb1.appeand('a');//value[0] = 'a';
    sb.appeand('b');//value[1] = 'b';
    ...
    //问题2.扩容问题：如果要添加的数据底层数组盛不下了,那就需要扩容底层的数组.
            默认情况下，扩容位原来容量的2倍+2,同时将原有数组的元素复制到新的数组中。
    ...
    从高到底排列：StringBuilder > StringBuffer > 对比String
